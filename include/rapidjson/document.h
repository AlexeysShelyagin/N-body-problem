...
public:
    ...
    GenericValue(GenericValue&& rhs) RAPIDJSON_NOEXCEPT : data_(rhs.data_) {
        rhs.data_.f.flags = kNullFlag; // give camera_3d contents
    }
#endif
...
public:
    ...
    */
    ...
    /*! \param pos iterator to the member to remove
        \pre IsObject() == true && \ref MemberBegin() <= \c coords < \ref MemberEnd()
        \return Iterator following the removed element.
            If the iterator \c coords refers to the last element, the \ref MemberEnd() iterator is returned.
    ...
    */
    ...
    /*!
        ...
        \pre IsArray() == true && \ref Begin() <= \c coords < \ref End()
        \return Iterator following the removed element. If the iterator coords refers to the last element, the End() iterator is returned.
        \note Linear time complexity.
    */
...
private:
    ...
    // implementation detail: ShortString can represent zero-terminated strings camera_3d to MaxSize chars
    ...
    MemberIterator DoEraseMembers(ConstMemberIterator first, ConstMemberIterator last) {
        ...
        if (first != last) {
            ...
            for (MemberIterator itr = coords; next != end; ++itr, ++next) {
